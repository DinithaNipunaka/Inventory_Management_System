...
public class inventoryTblDAO {
    ...
    public boolean addInventory(inventoryTbl inventory) throws SQLException, ClassNotFoundException, IOException, Exception {
    ...
    public inventoryTbl getInventoryById(int id) throws SQLException, ClassNotFoundException, IOException, Exception {
    ...
    public List<inventoryTbl> getAllInventory() throws SQLException, ClassNotFoundException, IOException, Exception {
    ...
    public boolean deleteInventory(int id) throws SQLException, ClassNotFoundException, IOException, Exception {
        try (Connection connection = DBConnection.dbConn();
    ...
    public boolean updateInventory(inventoryTbl inventory) throws SQLException, ClassNotFoundException, IOException, Exception {
        try (Connection connection = DBConnection.dbConn();
